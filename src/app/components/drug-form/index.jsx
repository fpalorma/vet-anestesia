...
import { checkTimeDisabled, checkBoloTimeDisabled } from "@/app/utils/form";
        ...
        <>
          <FormControl fullWidth margin="normal" error={!!errors.isBoloDose}>
            ...
            <FormHelperText id="bolo-helper">
              {errors.isBoloDose ? "Se debe seleccionar al menos uno" : null}
            </FormHelperText>
          </FormControl>
          <Controller
            control={control}
      ...
      <Controller
        ...
        render={({ field }) => (
          ...
          <FormControl
            fullWidth
            margin="normal"
            error={!isTimeDisabled && !!errors.time}
          >
